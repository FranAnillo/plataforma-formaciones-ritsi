    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-red-50 to-red-100 dark:from-gray-900 dark:via-black dark:to-black text-gray-800 dark:text-gray-200" style={{ fontFamily: 'Exo, sans-serif' }}>
      ...
      <header className="container mx-auto px-4 sm:px-6 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl sm:text-2xl font-bold">Gestión de Formaciones RITSI</h1>
          </div>
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="bg-[#da2724] hover:bg-[#b8211e] text-white px-4 sm:px-6 py-2 rounded-full font-medium shadow-lg hover:shadow-xl transition-all text-sm sm:text-base"
            >
              Iniciar Sesión
            </Button>
          </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 md:py-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-base sm:text-xl text-gray-600 dark:text-gray-400 mb-8 sm:mb-10 leading-relaxed">
          ...
          <Button
            ...
            onClick={() => window.location.href = AUTH_URL}
            size="lg"
            className="bg-[#da2724] hover:bg-[#b8211e] text-white px-8 py-5 sm:py-6 rounded-full text-base sm:text-lg font-semibold shadow-2xl hover:shadow-3xl transition-all hover:scale-105"
          >
            Comenzar Ahora
          </Button>
        </div>
      ...
      {/* Footer */}
      <footer className="container mx-auto px-4 sm:px-6 py-8 mt-16 sm:mt-20 border-t border-gray-200 dark:border-gray-800">
...
function FeatureCard({ icon, title, description }) {
  return (
    <div className="bg-white/60 dark:bg-gray-800/40 p-6 sm:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all border border-gray-100 dark:border-gray-800 hover:border-red-200 dark:hover:border-red-500/30">
